...
import dedent from "../../node_modules/dedent/dist/dedent.js";
    ...
    ws: {
      ...
      onerror: function(e) {
        ...
        if (_status.connectCallback) {
          ...
          const shouldReconnect = game.online && _status.ip && lib.element.ws._reconnectAttempts < lib.element.ws._maxReconnectAttempts;
          if (!shouldReconnect) {
            alert("连接失败");
          }
        }
      ...
      onclose: function() {
        ...
        if ((game.online || game.onlineroom) && _status.ip && !lib.element.ws._isReconnecting && lib.element.ws._reconnectAttempts < lib.element.ws._maxReconnectAttempts) {
